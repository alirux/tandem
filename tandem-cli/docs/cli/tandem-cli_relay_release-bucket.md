## tandem-cli relay release-bucket

Force-release a bucket for reassignment (zombie owner recovery)

```
tandem-cli relay release-bucket <bucket> [flags]
```

### Options

```
  -h, --help   help for release-bucket
```
