 ...
 *                         does not mean no relay is running, only that this reading cannot see it
 */
public record RelayStatusView(boolean paused, int bucketCount, int uncoveredBuckets, int workers) {
}
